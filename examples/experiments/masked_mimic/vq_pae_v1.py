...
#
"""VQ-PAE variant that uses future max-coords observations instead of target poses."""
...
_TRANSFORMER_MODULE = _load_sibling_module(
    "transformer.py", "masked_mimic_transformer_experiment_v1"
)
_BASE_VQPAE_MODULE = _load_sibling_module("vq_pae.py", "masked_mimic_vq_pae_base_v1")
