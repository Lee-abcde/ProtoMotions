...
#
"""BeyondMimic PPO config using the VQ-PAE actor with L2C2 regularization.

Keeps the VQ-PAE multi-future-frame conditioning and auxiliary reconstruction/codebook
losses from the distillation setup, but optimizes the actor with PPO task rewards.
"""
...
def env_config(robot_cfg: RobotConfig, args: argparse.Namespace) -> EnvConfig:
    ...
    observation_components = {
        ...
        "clean_trunk_proj_gravity": MdpComponent(
            compute_func=build_projected_gravity_obs,
        ...
        "encoder_future_target_obs": MdpComponent(
            ...
            static_params={
                "future_steps": list(range(1, NUM_FUTURE_STEPS + 1)),
                "w_last": True,
            },
        ),
        ...
        "clean_trunk_target_relative_rot": MdpComponent(
            compute_func=build_future_relative_anchor_rot_obs,
            dynamic_vars={
...
def agent_config(
    ...
    vq_pae_actor_config = DistillVQPAEModelConfig(
        prior_in_keys=["max_coords_obs_norm", "historical_pose_obs_norm"],
        posterior_in_keys=[
            "max_coords_obs_norm",
            "vq_pae_target_poses_norm",
            "historical_pose_obs_norm",
    ...
    return PPOAgentConfig(
        ...
        l2c2=L2C2Config(
            ...
            obs_pairs={
                ...
                "trunk_proj_gravity": "clean_trunk_proj_gravity",
