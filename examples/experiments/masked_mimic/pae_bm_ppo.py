...
#
"""BeyondMimic PPO config using the continuous PAE actor with L2C2 regularization.

Keeps the VQ-PAE observation setup and phase-manifold structure, but removes the
vector-quantized codebook so the latent state stays continuous.
"""
...
def agent_config(
    ...
    pae_actor_config = DistillPAEModelConfig(
