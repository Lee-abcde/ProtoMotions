...
#
"""Configuration classes for the VQ-PAE MaskedMimic variant.

Kept separate from the original MaskedMimic config definitions so experiment-
specific latent-model changes do not mix with the base VAE pipeline.
"""
