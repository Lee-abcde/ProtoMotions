...
@dataclass
class PAELossConfig:
    """Auxiliary loss weights for the phase-aware autoencoder model."""
...
@dataclass
class DistillPAEModelConfig(BaseModelConfig):
    """Configuration for the continuous phase-aware autoencoder variant."""

    _target_: str = "protomotions.agents.distill.pae.DistillPAEModel"
    ...
    losses: PAELossConfig = field(default_factory=PAELossConfig)
